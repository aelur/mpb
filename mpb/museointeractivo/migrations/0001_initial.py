    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curiosidades_es', models.FileField(default=b'', upload_to=b'/home/agustina/mpb/mpb/media', blank=True, help_text=b'Texto de curiosidades - obligatorio si es nacional.', verbose_name=b'Curiosidades - Espa\xc3\xb1ol')),
                ('curiosidades_en', models.FileField(default=b'', upload_to=b'/home/agustina/mpb/mpb/media', blank=True, help_text=b'Texto de curiosidades - obligatorio si es nacional.', verbose_name=b'Curiosidades - Ingl\xc3\xa9s')),
                ('curiosidades_por', models.FileField(default=b'', upload_to=b'/home/agustina/mpb/mpb/media', blank=True, help_text=b'Texto de curiosidades - obligatorio si es nacional.', verbose_name=b'Curiosidades - Portugu\xc3\xa9s')),
                ...
                ('tablas', models.FileField(help_text=b"Archivo Excel XLSX con informaci\xc3\xb3n de: posiciones del campeonato (pesta\xc3\xb1a 'posiciones'), jugadores (pesta\xc3\xb1a 'jugadores'), y la campa\xc3\xb1a (pesta\xc3\xb1a 'campania').", upload_to=b'/home/agustina/mpb/mpb/media')),
            ],
        ),
    ]
